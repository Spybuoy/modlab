...
L_phi = (
    (Constant(0) * q * DX) + (neumann_bc_val * q * ds_bot)
...
pvd_output_file = File(path 
+ "/nov09/Dim (300e-6, 200e-6, 10e-6)/F_mag"+foldername + filename)
pvd_output_file << F_magnitude_func

# Save the magnitude of the electric field
pvd_output_file_ = File(path 
+ "/nov09/Dim (300e-6, 200e-6, 10e-6)/F/"+foldername + filename)
pvd_output_file_ << F


# Save the magnitude of the electric field
pvd_output_file = File(path 
+ "/nov09/Dim (300e-6, 200e-6, 10e-6)/E_mag/"+foldername + filename)
pvd_output_file << E_magnitude_func

# Save the magnitude of the electric field
pvd_output_file_ = File(path 
+ "/nov09/Dim (300e-6, 200e-6, 10e-6)/E/"+foldername + filename)
pvd_output_file_ << E
